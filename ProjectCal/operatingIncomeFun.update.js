...
netOperatingIncome.cal = (data, data1, data2, data3, op) => {


    // console.log("data3", data3[0].opIncome)
...
operatingIncomeSchema.find({}, function(err, opiobj) {
    ...
    opiobj.forEach(function(value) {
        ...
        if(value.Net_Operating_Income == 1) {
            oIcm.push(a*b)
            third.push(data3[0].opIncome[0].Insurance)
            fourth.push(data3[0].opIncome[0].Utilities)
            fifth.push(data3[0].opIncome[0].Repairs_and_Maintenance)
            sixth.push(data3[0].opIncome[0].Cleaning_and_GarbageRemoval)
            seventh.push(data3[0].opIncome[0].Contract_Services)
            eighth.push(data3[0].opIncome[0].General_and_Administrative)
            nineth.push(data3[0].opIncome[0].Turnover)
            tenth.push(data3[0].opIncome[0].Marketing)
            eleventh.push(data3[0].opIncome[0].Payroll)
            twelth.push(data3[0].opIncome[0].Other)
            thirteenth.push(data3[0].opIncome[0].Miscellaneous)
        ...
        if(value.Net_Operating_Income == 2) {
            ...
            third.push(data3[0].opIncome[1].Insurance)
            fourth.push(data3[0].opIncome[1].Utilities)
            fifth.push(data3[0].opIncome[1].Repairs_and_Maintenance)
            sixth.push(data3[0].opIncome[1].Cleaning_and_GarbageRemoval)
            seventh.push(data3[0].opIncome[1].Contract_Services)
            eighth.push(data3[0].opIncome[1].General_and_Administrative)
            nineth.push(data3[0].opIncome[1].Turnover)
            tenth.push(data3[0].opIncome[1].Marketing)
            eleventh.push(data3[0].opIncome[1].Payroll)
            twelth.push(data3[0].opIncome[1].Other)
            thirteenth.push(data3[0].opIncome[1].Miscellaneous)
        ...
        if(value.Net_Operating_Income == 3) {
            ...
            fourth.push((fourth[1]*c).toFixed(2))
            fifth.push((fifth[1]*c).toFixed(2))
            sixth.push((sixth[1]*c).toFixed(2))
            seventh.push((seventh[1]*c).toFixed(2))
            eighth.push((eighth[1]*c).toFixed(2))
            nineth.push((nineth[1]*c).toFixed(2))
            tenth.push((tenth[1]*c).toFixed(2))
            eleventh.push((eleventh[1]*c).toFixed(2))
            twelth.push((twelth[1]*c).toFixed(2))
            thirteenth.push((thirteenth[1]*c).toFixed(2))
        ...
        if(value.Net_Operating_Income == 4) {
            ...
            third.push((third[2]*c).toFixed(2))
            fourth.push((fourth[2]*c).toFixed(2))
            fifth.push((fifth[2]*c).toFixed(2))
            sixth.push((sixth[2]*c).toFixed(2))
            seventh.push((seventh[2]*c).toFixed(2))
            eighth.push((eighth[2]*c).toFixed(2))
            nineth.push((nineth[2]*c).toFixed(2))
            tenth.push((tenth[2]*c).toFixed(2))
            eleventh.push((eleventh[2]*c).toFixed(2))
            twelth.push((twelth[2]*c).toFixed(2))
            thirteenth.push((thirteenth[2]*c).toFixed(2))
        ...
        if(value.Net_Operating_Income == 5) {
            ...
            third.push((third[3]*c).toFixed(2))
            fourth.push((fourth[3]*c).toFixed(2))
            fifth.push((fifth[3]*c).toFixed(2))
            sixth.push((sixth[3]*c).toFixed(2))
            seventh.push((seventh[3]*c).toFixed(2))
            eighth.push((eighth[3]*c).toFixed(2))
            nineth.push((nineth[3]*c).toFixed(2))
            tenth.push((tenth[3]*c).toFixed(2))
            eleventh.push((eleventh[3]*c).toFixed(2))
            twelth.push((twelth[3]*c).toFixed(2))
            thirteenth.push((thirteenth[3]*c).toFixed(2))
        ...
        if(value.Net_Operating_Income == 6) {
            ...
            third.push((third[4]*c).toFixed(2))
            fourth.push((fourth[4]*c).toFixed(2))
            fifth.push((fifth[4]*c).toFixed(2))
            sixth.push((sixth[4]*c).toFixed(2))
            seventh.push((seventh[4]*c).toFixed(2))
            eighth.push((eighth[4]*c).toFixed(2))
            nineth.push((nineth[4]*c).toFixed(2))
            tenth.push((tenth[4]*c).toFixed(2))
            eleventh.push((eleventh[4]*c).toFixed(2))
            twelth.push((twelth[4]*c).toFixed(2))
            thirteenth.push((thirteenth[4]*c).toFixed(2))
        ...
        if(value.Net_Operating_Income == 7) {
            ...
            third.push((third[5]*c).toFixed(2))
            fourth.push((fourth[5]*c).toFixed(2))
            fifth.push((fifth[5]*c).toFixed(2))
            sixth.push((sixth[5]*c).toFixed(2))
            seventh.push((seventh[5]*c).toFixed(2))
            eighth.push((eighth[5]*c).toFixed(2))
            nineth.push((nineth[5]*c).toFixed(2))
            tenth.push((tenth[5]*c).toFixed(2))
            eleventh.push((eleventh[5]*c).toFixed(2))
            twelth.push((twelth[5]*c).toFixed(2))
            thirteenth.push((thirteenth[5]*c).toFixed(2))
        ...
        if(value.Net_Operating_Income == 8) {
            ...
            third.push((third[6]*c).toFixed(2))
            fourth.push((fourth[6]*c).toFixed(2))
            fifth.push((fifth[6]*c).toFixed(2))
            sixth.push((sixth[6]*c).toFixed(2))
            seventh.push((seventh[6]*c).toFixed(2))
            eighth.push((eighth[6]*c).toFixed(2))
            nineth.push((nineth[6]*c).toFixed(2))
            tenth.push((tenth[6]*c).toFixed(2))
            eleventh.push((eleventh[6]*c).toFixed(2))
            twelth.push((twelth[6]*c).toFixed(2))
            thirteenth.push((thirteenth[6]*c).toFixed(2))
        ...
        if(value.Net_Operating_Income == 9) {
            ...
            third.push((third[7]*c).toFixed(2))
            fourth.push((fourth[7]*c).toFixed(2))
            fifth.push((fifth[7]*c).toFixed(2))
            sixth.push((sixth[7]*c).toFixed(2))
            seventh.push((seventh[7]*c).toFixed(2))
            eighth.push((eighth[7]*c).toFixed(2))
            nineth.push((nineth[7]*c).toFixed(2))
            tenth.push((tenth[7]*c).toFixed(2))
            eleventh.push((eleventh[7]*c).toFixed(2))
            twelth.push((twelth[7]*c).toFixed(2))
            thirteenth.push((thirteenth[7]*c).toFixed(2))
        ...
        if(value.Net_Operating_Income == 10) {
            ...
            third.push((third[8]*c).toFixed(2))
            fourth.push((fourth[8]*c).toFixed(2))
            fifth.push((fifth[8]*c).toFixed(2))
            sixth.push((sixth[8]*c).toFixed(2))
            seventh.push((seventh[8]*c).toFixed(2))
            eighth.push((eighth[8]*c).toFixed(2))
            nineth.push((nineth[8]*c).toFixed(2))
            tenth.push((tenth[8]*c).toFixed(2))
            eleventh.push((eleventh[8]*c).toFixed(2))
            twelth.push((twelth[8]*c).toFixed(2))
            thirteenth.push((thirteenth[8]*c).toFixed(2))
        ...
        if(value.Net_Operating_Income == 11) {
            ...
            third.push((third[9]*c).toFixed(2))
            fourth.push((fourth[9]*c).toFixed(2))
            fifth.push((fifth[9]*c).toFixed(2))
            sixth.push((sixth[9]*c).toFixed(2))
            seventh.push((seventh[9]*c).toFixed(2))
            eighth.push((eighth[9]*c).toFixed(2))
            nineth.push((nineth[9]*c).toFixed(2))
            tenth.push((tenth[9]*c).toFixed(2))
            eleventh.push((eleventh[9]*c).toFixed(2))
            twelth.push((twelth[9]*c).toFixed(2))
            thirteenth.push((thirteenth[9]*c).toFixed(2))
        ...
        if(value.Net_Operating_Income == 12) {
            ...
            third.push((third[10]*c).toFixed(2))
            fourth.push((fourth[10]*c).toFixed(2))
            fifth.push((fifth[10]*c).toFixed(2))
            sixth.push((sixth[10]*c).toFixed(2))
            seventh.push((seventh[10]*c).toFixed(2))
            eighth.push((eighth[10]*c).toFixed(2))
            nineth.push((nineth[10]*c).toFixed(2))
            tenth.push((tenth[10]*c).toFixed(2))
            eleventh.push((eleventh[10]*c).toFixed(2))
            twelth.push((twelth[10]*c).toFixed(2))
            thirteenth.push((thirteenth[10]*c).toFixed(2))
        ...
        if(value.Net_Operating_Income == 13) {
            ...
            third.push((third[11]*c).toFixed(2))
            fourth.push((fourth[11]*c).toFixed(2))
            fifth.push((fifth[11]*c).toFixed(2))
            sixth.push((sixth[11]*c).toFixed(2))
            seventh.push((seventh[11]*c).toFixed(2))
            eighth.push((eighth[11]*c).toFixed(2))
            nineth.push((nineth[11]*c).toFixed(2))
            tenth.push((tenth[11]*c).toFixed(2))
            eleventh.push((eleventh[11]*c).toFixed(2))
            twelth.push((twelth[11]*c).toFixed(2))
            thirteenth.push((thirteenth[11]*c).toFixed(2))
        ...
        if(value.Net_Operating_Income == 14) {
            ...
            third.push((third[12]*c).toFixed(2))
            fourth.push((fourth[12]*c).toFixed(2))
            fifth.push((fifth[12]*c).toFixed(2))
            sixth.push((sixth[12]*c).toFixed(2))
            seventh.push((seventh[12]*c).toFixed(2))
            eighth.push((eighth[12]*c).toFixed(2))
            nineth.push((nineth[12]*c).toFixed(2))
            tenth.push((tenth[12]*c).toFixed(2))
            eleventh.push((eleventh[12]*c).toFixed(2))
            twelth.push((twelth[12]*c).toFixed(2))
            thirteenth.push((thirteenth[12]*c).toFixed(2))
        ...
        if(value.Net_Operating_Income == 15) {
            ...
            third.push((third[13]*c).toFixed(2))
            fourth.push((fourth[13]*c).toFixed(2))
            fifth.push((fifth[13]*c).toFixed(2))
            sixth.push((sixth[13]*c).toFixed(2))
            seventh.push((seventh[13]*c).toFixed(2))
            eighth.push((eighth[13]*c).toFixed(2))
            nineth.push((nineth[13]*c).toFixed(2))
            tenth.push((tenth[13]*c).toFixed(2))
            eleventh.push((eleventh[13]*c).toFixed(2))
            twelth.push((twelth[13]*c).toFixed(2))
            thirteenth.push((thirteenth[13]*c).toFixed(2))
