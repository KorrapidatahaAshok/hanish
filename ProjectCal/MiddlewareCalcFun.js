...
middlewareCalc.cal = (obj,cb) => {
    ...
    homeTypeDataSchema.find({}, function(err, homeobj) {
        ...
        // console.log(homeobj)
        fmrRentsSchema.findOne({"Area_Name": obj.MetroArea}, function(err, fmrobj) {

            if(err) {
            console.log(err) 
            var output = {

                msg: "Metro Area Data not found"
            }
            return cb(output)
            ...
            if (i == 0) {
                ...
                rentmaxarray.push(fmrobj.Person_1);
                ...
                rentmaxarray.push(fmrobj.People_2);
                familyarray.push(homeobj[i].Beds + 1);
                totalSqFtarray.push(homeobj[i].Estimated_Sq_Ft * unitsarray[i])
                rentcharged.push(rentmaxarray[i] * (1-(proobj.Additional_Rent_Discount/100)))
                rentmonthly.push(rentcharged[i] * unitsarray[i])
                ...
                rentmaxarray.push(fmrobj.People_3);
                familyarray.push(homeobj[i].Beds + 1);
                totalSqFtarray.push(homeobj[i].Estimated_Sq_Ft * unitsarray[i])
                rentcharged.push(rentmaxarray[i] * (1-(proobj.Additional_Rent_Discount/100)))
                rentmonthly.push(rentcharged[i] * unitsarray[i])
                ...
                rentmaxarray.push(fmrobj.People_4);
                familyarray.push(homeobj[i].Beds + 1);
                totalSqFtarray.push(homeobj[i].Estimated_Sq_Ft * unitsarray[i])
                rentcharged.push(rentmaxarray[i] * (1-(proobj.Additional_Rent_Discount/100)))
                rentmonthly.push(rentcharged[i] * unitsarray[i])
                ...
                rentmaxarray.push(fmrobj.People_5);
                familyarray.push(homeobj[i].Beds + 1);
                totalSqFtarray.push(homeobj[i].Estimated_Sq_Ft * unitsarray[i])
                rentcharged.push(rentmaxarray[i] * (1-(proobj.Additional_Rent_Discount/100)))
                rentmonthly.push(rentcharged[i] * unitsarray[i])
